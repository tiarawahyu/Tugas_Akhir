...
<center><b><p style="font-size: 100px; color : black">Keranjang Belanja</p></b></center>
  <section class="ftco-section ftco-Keranjang Belanja">
                  ...
                  <div class="cart-list">
                      <table class="table">
                          ...
                          <tbody>
                              ...
                              <?php
                              array_push($qty_key, "quantity[" . $item['rowid'] . "]<>". $item['qty']);
                            endforeach;
                            $_SESSION["QTY_CART"] = $qty_key;
                            ?>
                          </tbody>
                        </table>
                    </div>
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate" >
                <div class="alert alert-info" style='color: black';>Tidak ada barang dalam keranjang.<br><a href="<?php echo base_url(); ?>" > Jelajahi produk kami dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
