...
<section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
  ...
  <footer class="ftco-footer ftco-section">
    <div class="container">
        <div class="row" >
            <div class="mouse">
                      <a href="#" class="mouse-icon" style="background-color: #343a40;">
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
              ...
              <li class="ftco-animate"><a href="https://www.instagram.com/a5j.basic?utm_source=ig_web_button_share_sheet&igsh=OGQ5ZDc2ODk2ZA=="><span class="icon-instagram"></span></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">a5J Basic Custom & T-shirt</h2>
              <div class="block-23 mb-3">
                <ul>
                  <li><a href="https://www.google.com/maps/place/Jl.+Sukahaji+No.116,+Sukarasa,+Kec.+Sukasari,+Kota+Bandung,+Jawa+Barat+40152,+Indonesia/@-6.870175,107.585284,17z/data=!4m6!3m5!1s0x2e68e699c4459581:0x8d44fd5bef05d031!8m2!3d-6.8707423!4d107.5850273!16s%2Fg%2F11c5dpqn0x?hl=en&entry=ttu"><span class="fas fa-location-dot fa-lg" style="color: black;"></span>&nbsp&nbsp&nbsp&nbsp<span class="text"><?php echo get_settings('store_address'); ?></span></li>
                  <li><a href="https://wa.me/qr/ZFKLKFT2D5C7E1"><span class="fas fa-phone fa-lg" style="color: black;"></span>&nbsp&nbsp&nbsp&nbsp<span class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
                  <li><a href="#"><span class="fas fa-envelope fa-lg" style="color: black;"></span>&nbsp&nbsp&nbsp&nbsp<span class="text"><?php echo get_settings('store_email'); ?></span></a></li>
                </ul>
              </div>
          </div>
        </div>
