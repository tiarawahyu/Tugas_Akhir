        ...
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3 d-flex">
              <div class="info bg-white p-4">
                <center><p style="color: black;"><span><b>Alamat</b></span> <br><?php echo get_settings('store_address'); ?></p></center>
              </div>
          </div>
          <div class="col-md-3 d-flex">
              <div class="info bg-white p-4">
                <center><p style="color: black;"><span><b>No. HP</b></span> <br><?php echo get_settings('store_phone_number'); ?></p></center>
              </div>
          </div>
          <div class="col-md-3 d-flex">
              <div class="info bg-white p-4">
                <center><p style="color: black;"><span><b>Email</b></span> <br><?php echo get_settings('store_email'); ?></p></center>
              </div>
          </div>
          <!-- <div class="col-md-3 d-flex">
              <div class="info bg-white p-4">
