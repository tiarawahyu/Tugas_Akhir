...
Config::$clientKey = 'SB-Mid-client-M6iWltXl2qrwZkRs';
Config::$serverKey = 'SB-Mid-server-cBZGDpbKwygdGoyAvyj1gBPj';
...
function printExampleWarningMessage() {
    if (strpos(Config::$clientKey, 'your ') != false ) {
        ...
        echo "<br>";
        echo "<br>";
        echo htmlspecialchars('Config::$clientKey = \'SB-Mid-client-M6iWltXl2qrwZkRs\';');
        die();
    } 
}
?>
...
<body>
    ...
    <form action="<?php echo site_url('payment2/checkout'); ?>" method="POST">
        <fieldset>
