...
<html lang="id-ID">
    ...
    <body style="background: #f0f0f0 !important;">
        ...
        <div class=" w3l-login-form">
            <center><a style="font-size: 45px; color : #fc3955;"><b>LOGIN AKUN</b></a></center><br>
        ...
        <!-- <footer>
            <p class="copyright-agileinfo" style="color :black"> &copy; 2023 <?php echo anchor (base_url(), get_store_name()); ?></p>
        </footer> -->
