              ...
              <div class="card-body p-0">
                ...
                <?php if($data->{"order_status"} == "5"){ ?>
                            ...
                            <?php }else if($midtrans == null){ ?>
                                <tr>
                                    <td><i>Pembeli belum memilih pembayaran</i></td>
                                    <td></td>
                                </tr>
                                <!-- <tr>
                                    <td>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body p-0">
                    <table class="table align-items-center table-flush table-hover">
                        ...
                        <tr>
                            <td>Alamat</td>
                            <td><div style="white-space: initial;"><b>JNE <?php echo $delivery_data->pengiriman_service . " - " . $delivery_data->pengiriman_description . " - " . $delivery_data->pengiriman_etd; ?></b></div></td>
                        </tr>
                        <tr>
                            <td>Ongkir</td>
                            <td><b>Rp <?php echo format_rupiah($delivery_data->pengiriman_value); ?></b></td>
