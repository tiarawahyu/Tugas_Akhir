            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><?php echo anchor('customer/orders', 'Order Saya'); ?></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-7">
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <tr>
                                <td>Ongkir</td>
                                <td><b>Rp <?php echo format_rupiah($delivery_data->pengiriman_value); ?></b></td>
                            </tr>
                            <tr>
                                <td>Total Order</td>
                                <td><b>Rp <?php echo format_rupiah($data->total_price + $delivery_data->pengiriman_value); ?></b></td>
                            </tr>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-heading">Detail Pembayaran</h5>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            <form action="<?php echo site_url('payment/tes_checkout_order'); ?>" method="POST" id="form-pay">
                                <input type="hidden" name="order_id" value="<?php echo $data->{"id"}; ?>">
                                <input type="submit" value="Pay with Snap Redirect" style="display: none;">
                            </form>
                            
                            <?php if($data->{"order_status"} == "5"){ ?>
                                <tr>
                                    <td><i>Order anda telah dibatalkan</i></td>
                                    <td></td>
                                </tr>
                            <?php }else if($midtrans == null){ ?>
                                <tr>
                                    <td><i>Anda belum memilih pembayaran</i></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="btn btn-info div-submit" idate>Pilih Pembayaran</div>
                                    </td>
                                    <td></td>
                                </tr>
                            <?php }else{ ?>
                            <tr>
                                <td>ID Transaksi</td>
                                <td><b><?php echo $midtrans->{"transaction_id"}; ?></b></td>
                            </tr>
                            <!-- buat konstanta payment_type, transaction_status -->
                            <tr>
                                <td>Jenis Pembayaran</td>
                                <td><b><?php echo ucwords(str_replace("_", " ", $midtrans->{"payment_type"})); ?></b></td>
                            </tr>
                            <tr>
                                <td>Tanggal Pemilihan Pembayaran</td>
                                <td><b><?php echo $midtrans->{"transaction_time"}; ?></b></td>
                            </tr>
                            <tr>
                                <td>Tanggal Kadaluarsa</td>
                                <td><b><?php echo $midtrans->{"expiry_time"}; ?></b></td>
                            </tr>
                            <tr>
                                <td>Status Pembayaran</td>
                                <td><b><i><?php echo $midtrans->{"transaction_status"}; ?></i></b></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <form action="<?php echo site_url('payment/tes_transaction_status'); ?>" method="POST" id="form-cek">
                                        <input type="hidden" name="order_id" value="<?php echo $data->{"order_number"}; ?>">
                                        <input type="hidden" name="redirect" value="<?php echo $data->{"id"}; ?>">
                                        <input type="submit" class="btn btn-info" value="Cek" style="">
                                    </form>
                                </td>
                            </tr>
                            <!-- detail teknis pembayaran, misal VA -->
                            <?php } ?>
                        </table>
                    </div>
                    
                    <script>
                        var divsToClick = document.getElementsByClassName('div-submit');
                        Array.from(divsToClick).forEach(function(div) {
                            div.addEventListener('click', function() {
                                var formToSubmit = document.getElementById('form-pay');
                                formToSubmit.submit();
                            });
                        });
                    </script>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <tr>
                                <td>Email</td>
                                <td><b><?php echo $delivery_data->customer->email; ?></b></td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                            ...
                            <tr>
                                <td>Kota</td>
                                <td><b><?php echo $delivery_data->kota; ?></b></td>
                            </tr>
                            <tr>
                                <td>Kode Pos</td>
                                <td><b><?php echo $delivery_data->kode_pos; ?></b></td>
                            </tr>
                            <tr>
                                <td>Pengiriman</td>
                                <td><b>JNE <?php echo $delivery_data->pengiriman_service . " - " . $delivery_data->pengiriman_description . " - " . $delivery_data->pengiriman_etd; ?></b></td>
                            </tr>
                            <tr>
                                <td>Ongkir</td>
                                <td><b>Rp <?php echo format_rupiah($delivery_data->pengiriman_value); ?></b></td>
